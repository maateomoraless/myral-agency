...
const whatWeDid = [
  ...
  "Monitorización en tiempo real del flujo de asistentes",
...
export default function LeyendasPage() {
  return (
    <>
      <section className="no-reveal relative min-h-[85vh] overflow-hidden bg-[#111]">
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="font-[var(--font-syne)] text-[clamp(4rem,13vw,10rem)] font-extrabold text-white/10">
            MYRAL.
          </span>
        </div>
        ...
        <div className="section-pad relative z-10 flex min-h-[85vh] flex-col justify-end">
          <span className="mb-4 inline-block border border-[#F5E614]/30 bg-[#F5E614]/10 px-3 py-1 text-[9px] uppercase tracking-[0.18em] text-[#F5E614]">
            Gestión Integral de Evento · 2025
          </span>
      ...
      <section className="section-pad">
        <p className="max-w-3xl text-[14px] leading-[1.85] text-[var(--muted)]">
          Festival de música latina en León, España. MYRAL asumió la dirección y gestión integral — desde la estrategia
          de comunicación y venta de entradas hasta la logística de transporte y la coordinación del día del evento.
        </p>
      </section>

      <section className="section-pad section-alt">
        <h2 className="mb-6 font-[var(--font-syne)] text-3xl font-bold">El reto</h2>
        <p className="max-w-3xl text-[14px] leading-[1.85] text-[var(--muted)]">
          Organizar un evento de 2.500 personas con múltiples proveedores, fechas y canales no es un problema de
          logística. Es un problema de sistemas.
        </p>
      </section>

      <section className="section-pad">
        <h2 className="mb-8 font-[var(--font-syne)] text-3xl font-bold">Lo que hicimos</h2>
      ...
      <section className="section-pad section-alt">
        <h2 className="mb-8 font-[var(--font-syne)] text-3xl font-bold">El resultado</h2>
